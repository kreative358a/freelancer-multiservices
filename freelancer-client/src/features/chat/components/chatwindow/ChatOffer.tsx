...
const ChatOffer: FC<IChatMessageProps> = ({ message, seller, gig }): ReactElement => {
  ...
  return (
    <div
      className="z-1 border-grey mt-2 flex h-72 sm:max-w-[60%] lg:max-w-xl flex-col overflow-hidden rounded border"
      // className="z-1 border-grey mt-2 flex h-72 max-w-xl flex-col overflow-hidden rounded border"
    >
      <div className="w-full">
        <div className="border-grey flex flex-row justify-between border-b bg-blue-400/80 dark:bg-blue-800/80 p-4 text-sm font-bold md:text-base">
