  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center">
      ...
      <Button
        onClick={() => navigate(-1)}
        disabled={false}
        className="mt-5 rounded bg-sky-500/90 hover:bg-sky-500 px-6 py-3 text-center text-sm font-bold text-white focus:outline-none md:px-4 md:py-2 md:text-base"
        label="Back Home"
      />
    </div>
  );
