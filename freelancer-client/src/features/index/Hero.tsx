...
const Hero: FC = (): ReactElement => {
  ...
  useEffect(() => {
    const typed = new Typed(typedElement.current, {
      strings: [...categories, 'Programming & Tech'],
      startDelay: 300,
      typeSpeed: 120,
      backSpeed: 200,
      backDelay: 300
  ...
  return (
    <div className="relative bg-slate-100 dark:bg-slate-900 pb-20 pt-40 lg:pt-44">
      <div className="relative m-auto px-6 xl:container md:px-10 lg:px-6 xl:px-4">
        ...
        <h1 className="text-center text-4xl font-black text-blue-900 dark:text-white sm:mx-auto sm:w-10/12 sm:text-5xl md:w-10/12 md:text-5xl lg:w-auto lg:text-left xl:text-7xl">
          ...
          <span className="relative bg-gradient-to-r from-blue-700 to-cyan-700 text-transparent bg-clip-text dark:from-blue-400 dark:to-cyan-400">
            for your project
          </span>
          .
        </h1>
        <div className="lg:flex">
          <div className="relative mt-8 space-y-8 text-center sm:mx-auto sm:w-10/12 md:mt-16 md:w-2/3 lg:ml-0 lg:mr-auto lg:w-7/12 lg:text-left">
            ...
            <div className="flex w-full justify-between gap-6 lg:gap-12">
              <form
                className="mx-auto flex w-full items-center bg-white rounded-[4px]"
              ...
              >
                ...
                <div className="bg-sky-500  rounded-[4px]">
                  <Button
                    type="submit"
