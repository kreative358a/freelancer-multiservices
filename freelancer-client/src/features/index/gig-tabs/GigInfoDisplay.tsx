  ...
  return (
    <>
      ...
      <div className="flex w-screen flex-col">
        <Header navClass="navbar peer-checked:navbar-active relative z-20 w-full border-b border-gray-100 bg-slate-100 dark:bg-slate-900 shadow-2xl shadow-gray-600/5 backdrop-blur dark:border-gray-800 dark:bg-gray-900/80 dark:shadow-none" />
        {isLoading ? (
          <CircularPageLoader />
        ) : (
          <div className="relative m-auto mt-8 min-h-screen w-screen px-6 xl:container md:px-10 lg:px-6 xl:px-4">
            <main className="max-w-8xl container mx-auto mt-8">
              <h2 className="mb-4 px-4 text-xl font-bold lg:text-3xl">{gig.current.title}</h2>
              ...
              <div className="flex flex-wrap">
                <div className="order-last flex w-full flex-col p-4 lg:order-first lg:w-2/3">
                  <div className="relative flex max-h-[600px] cursor-pointer justify-center bg-blue-700/20 border border-blue-700/30">
                    {!isLoading && isSuccess && (
                      <img
                  ...
                  <div className="grid grid-cols-1 gap-y-4 lg:grid-cols-2">
                    <div className="flex flex-col">
                      <span className="text-slate-700 dark:text-slate-300 font-semibold">Main Categories</span>
                      <span className="font-normal">{gig.current.categories}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-slate-700 dark:text-slate-300 font-semibold">Sub Categories</span>
                      <div className="flex flex-col">
                      ...
                      <ul className="mb-0 list-none px-4 py-2">
                        ...
                        <li className="flex justify-between">
                          <div className="ml-15 flex w-full py-1">
                            <Button
                              className={
                                'text-md flex w-full cursor-pointer justify-between rounded bg-sky-600 px-8 py-2 font-bold text-white focus:outline-none '
                              }
