                ...
                {orderReviewModal.buyerPanel && (
                  <div className="my-3 flex flex-col">
                    <div className="relative overflow-x-auto">
                      <div className="border-grey w-full rounded border text-left text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div className="flex w-full cursor-pointer flex-col items-center space-x-4 px-5 py-4 md:flex-row">
                          ...
                          <div className="w-full text-sm dark:text-white xl:text-base">
                            <div className="flex justify-between text-sm font-bold text-slate-700 dark:text-slate-300 md:text-base">
                            ...
                            <div className="mt-1 flex flex-col justify-between text-slate-700 dark:text-slate-300">
