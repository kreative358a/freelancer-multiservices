            ...
            <div className="w-full">
              <div className="flex gap-4">
                ...
                <div className="border-grey w-full border-b pb-6">
                  <div className="flex items-center justify-between font-medium text-gray-600 dark:text-gray-400">
                    <div className="items-left mt-2 flex flex-col gap-2 md:flex-row md:items-center">
                  ...
                  <div className="border-grey mt-4 flex w-full flex-col rounded border">
                    <div className="mt-2">
                      <div className="px-4 py-1 text-left text-sm xl:text-base text-gray-600 dark:text-gray-400">
                        <div className="flex flex-col md:grid md:grid-cols-3">
                          <span className="col-span-1 text-sm font-bold">Original delivery date</span>
                          <p className="col-span-2 font-medium dark:font-normal text-blue-800 dark:text-blue-200">
                            {TimeAgo.dayMonthYear(order?.requestExtension.originalDate)}
                          </p>
                        </div>
                        <div className="mt-5 flex flex-col md:grid md:grid-cols-3">
                          ...
                          <p className="col-span-2 font-medium dark:font-normal text-blue-800 dark:text-blue-200">
                            {TimeAgo.dayMonthYear(order?.requestExtension.newDate)}
                          </p>
                        </div>
                        <div className="mt-5 flex flex-col md:grid md:grid-cols-3">
                ...
                <div className="flex items-center justify-between font-medium text-gray-600 dark:text-gray-400">
                  <div className="items-left mt-2 flex flex-col gap-2 md:flex-row md:items-center">
                    ...
                    <p className="text-sm font-normal italic text-teal-600 dark:text-teal-400">
                      {TimeAgo.dayWithTime(`${order?.events.deliveryDateUpdate}`)}
                    </p>
                  </div>
                </div>
                <div className="border-grey mt-4 flex w-full flex-col rounded border">
                  <div className="mt-2">
                    <div className="px-4 py-1 text-left text-sm xl:text-base text-gray-600 dark:text-gray-400">
                      <div className="flex flex-col md:grid md:grid-cols-3">
                        <span className="col-span-1 font-bold">Original delivery date</span>
                        <p className="col-span-2 font-medium dark:font-normal text-blue-800 dark:text-blue-200">
                          {TimeAgo.dayMonthYear(`${order?.offer.oldDeliveryDate}`)}
                        </p>
                      </div>
                      <div className="mt-4 flex flex-col md:grid md:grid-cols-3">
                        <span className="col-span-1 font-bold">New delivery date</span>
                        <p className="col-span-2 font-medium dark:font-normal text-blue-800 dark:text-blue-200">
                          {TimeAgo.dayMonthYear(`${order?.offer.newDeliveryDate}`)}
                        </p>
                      </div>
                      <div className="mt-4 flex flex-col md:grid md:grid-cols-3">
                        <span className="col-span-1 font-bold">Reason</span>
                        <p className="col-span-2 font-medium dark:font-normal text-blue-800 dark:text-blue-200">{order?.offer.reason}</p>
                      </div>
                    </div>
                  </div>
                </div>
