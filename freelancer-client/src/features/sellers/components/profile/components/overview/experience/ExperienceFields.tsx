    ...
    <>
      <div className="flex w-full flex-col">
        <div className="mb-6 px-3 md:mb-16">
          ...
          />
          <TextInput
            className="border-grey mb-4 w-full rounded p-2 text-sm xl:text-base font-normal text-gray-800 focus:outline-none"
          ...
          <div className="mb-4 mt-2 flex items-center">
            <TextInput
              ...
              className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 text-sm xl:text-base"
            ...
            />
            <label htmlFor="default-checkbox" className="ml-2 text-sm xl:text-base font-normal">
        ...
        <div className="z-20 mx-3 my-4 mt-10 flex cursor-pointer justify-start md:z-0 md:mt-0">
          <Button
            ...
            className={`md:text-base rounded bg-sky-500 px-6 py-1 text-center text-sm xl:text-base font-bold text-white hover:bg-sky-400 focus:outline-none md:py-2 ${
              (startDate === 'Start Year' ||
                endDate === 'End Year' ||
                !experienceItem.title ||
                !experienceItem.company ||
          ...
          <Button
            ...
            className="md:text-base rounded bg-rose-600/40 px-6 py-1 text-center text-sm xl:text-base font-bold hover:bg-rose-600/80 focus:outline-none md:py-2"
            label="Cancel"
          />
        </div>
      </div>
