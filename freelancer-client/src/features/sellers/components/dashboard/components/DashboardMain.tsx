    ...
    <div className="flex flex-wrap gap-x-4">
      <div className="order-firsts w-full py-4 xl:w-1/3">
        <StickyBox offsetTop={20} offsetBottom={20}>
          <div className="rounded border-2 border-gray-600/80 dark:border-gray-400/80 bg-blue-400/20 py-2">
            <div className="flex flex-col gap-y-3 pt-2">
              ...
              <div className="flex flex-col self-center">
                <div className="flex cursor-pointer self-center">
                  <span className="text-base xl:text-lg font-bold">{seller?.username}</span>
                </div>
                <span className="flex self-center px-4 text-center text-xs md:text-sm xl:text-lg">{seller?.oneliner}</span>
            ...
            <ul className="mb-0 list-none px-2 pt-1.5">
              <li className="mb-4 flex flex-col justify-between text-xs sm:mb-0 sm:flex-row sm:text-sm xl:text-lg">
      ...
      <div className="w-full py-4 xl:w-[65%]">
        <div className="rounded border-2 border-gray-600/80 dark:border-gray-400/80 text-blue-700 dark:text-blue-500">
          <ul className="flex w-full cursor-pointer list-none flex-col px-6 md:flex-row">
            <li
              onClick={() => setType('active')}
              className={`mr-9 w-full py-1 mb-2 text-xs font-semibold md:w-auto md:pt-3 md:pb-2 md:text-sm xl:text-lg hover:scale-[1.02] transition duration-300 ${
                type === 'active' ? 'text-sky-500 md:border-b-2 md:border-sky-500 font-bold' : ''
              }`}
            >
              ACTIVE GIGS
            </li>
            <li
              ...
              className={`mr-9 w-full py-1 mb-2 text-xs font-semibold md:w-auto md:pt-3 md:pb-2 md:text-sm xl:text-lg hover:scale-[1.02] transition duration-300 ${
                type === 'paused' ? 'text-sky-500 md:border-b-2 md:border-sky-500 font-bold' : ''
              }`}
            >
              PAUSED
            </li>
            <li
              ...
              className={`mr-9 w-full py-1 mb-2 text-xs font-semibold md:w-auto md:pt-3 md:pb-2 md:text-sm xl:text-lg hover:scale-[1.02] transition duration-300 ${
                type === 'orders' ? 'text-sky-500 md:border-b-2 md:border-sky-500 font-bold' : ''
              }`}
            >
              ACTIVE ORDERS
            </li>
