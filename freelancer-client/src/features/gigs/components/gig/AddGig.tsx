...
// import ReactQuill, {  UnprivilegedEditor }  from 'react-quill-ver2';
...
const AddGig: FC = (): ReactElement => {
  ...
  // const [gigInfo, setGigInfo] = useState<ICreateGig>(defaultGigInfo || 'Select a category');
  ...
  const onCreateGig = async (): Promise<void> => {
    try {
      // console.log('AddGig gigInfo: ', gigInfo);
      ...
      // 2) There will be no re-rendering of the component.
      ...
      console.log('AddGig error: ', error);
    ...
    <>
      ...
      <div className="relative w-screen">
        ...
        <div className="container relative mx-auto my-5 px-2 pb-12 md:px-0">
          ...
          <div className="border-grey left-0 top-0 z-10 mt-4 block rounded border bg-blue-300/40 dark:bg-blue-800/40 p-6">
            <div className="mb-4 grid md:grid-cols-5">
              <div className="pt-1 pb-2 text-base font-medium">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12">
                ...
                />
                <span className="flex justify-end text-xs lg:text-sm xl:text-base text-slate-700 dark:text-slate-300">
            ...
            <div className="mb-4 grid md:grid-cols-5">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12">
                ...
                />
                <span className="flex justify-end text-xs lg:text-sm text-slate-700 dark:text-slate-300">
            ...
            <div className="mb-4 grid md:grid-cols-5">
              ...
              <div className="col-span-4 md:w-11/12 lg:w-8/12 bg-blue-200/60 text-slate-800">
                <ReactQuill
                  theme="snow"
                  value={gigInfo.description}
                  className="border-grey border rounded text-gray-800"
                ...
                />
                <span className="flex justify-end bg-blue-200/0 text-xs lg:text-sm p-2 dark:text-slate-100 text-slate-800">
                  {allowedGigItemLength.descriptionCharacters} Characters
                </span>
              </div>
            </div>
            <div className="mb-8 grid md:grid-cols-5">
              <div className="pt-1 pb-2 text-base font-medium">
              ...
              <div className="relative col-span-4 md:w-11/12 lg:w-8/12">
                <Dropdown
                  ...
                  mainClassNames="absolute bg-white text-sm xl:text-base"
                  values={categories()}
                  onClick={(item: string) => {
            ...
            <TagsInput
              title="SubCategory"
              placeholder="Enter e.g. Website development, Mobile apps and press enter or comma"
              gigInfo={gigInfo}
            ...
            <TagsInput
              title="Tags"
              placeholder="Enter search terms for your gig and press enter or comma"
              gigInfo={gigInfo}
              setGigInfo={setGigInfo}
              tags={tags}
              itemInput={tagsInput}
            ...
            <div className="mb-8 grid md:grid-cols-5">
              ...
              <div className="relative col-span-4 md:w-11/12 lg:w-8/12">
                <Dropdown
                  ...
                  maxHeight="300"
                  showSearchInput={true}
                  mainClassNames="absolute bg-white text-sm xl:text-base z-40"
            ...
            <div className="mb-4 grid md:grid-cols-5">
              <div className="mt-6 pt-1 pb-2 text-base font-medium lg:mt-0">
                Cover image<sup className="top-[-0.3em] text-base text-red-500">*</sup>
              </div>
              <div className="relative col-span-4 md:w-11/12 lg:w-8/12">
                <div
                  className="outline h-[220px] w-[320px]"
                ...
                >
                  {gigInfo.coverImage && (
                    <img
                      ...
                      alt="Cover Image"
                      className="left-0 top-0 h-[220px] w-[320px] bg-white object-cover cursor-pointer"
                    />
                  )}
                  {!gigInfo.coverImage && (
                  ...
                  {showGigModal.image && (
                    <div
                      ...
                      className="absolute left-0 top-0 flex h-[220px] w-[320px] cursor-pointer justify-center bg-slate-300/60 dark:bg-slate-700/60"
                    >
            ...
            <div className="grid xs:grid-cols-1 md:grid-cols-5">
              <div className="pt-1 pb-2 text-base font-medium lg:mt-0"></div>
              <div className="col-span-4 flex gap-x-4 md:w-11/12 lg:w-8/12">
                <Button
                  disabled={isLoading}
                  className="rounded bg-sky-500 px-6 text-center text-sm lg:text-base font-bold text-white hover:bg-sky-400 focus:outline-none h-6 xl:h-8"
                  label="Create Gig"
                  onClick={onCreateGig}
                />
                <Button
                  disabled={isLoading}
                  className="rounded bg-red-500 px-6 text-center text-sm xl:text-base font-bold text-white hover:bg-red-400 focus:outline-none h-6 xl:h-8"
                  label="Cancel"
                  onClick={() => {
