...
const GigViewReviews: FC<IGigViewReviewsProps> = ({ showRatings, reviews, hasFetchedReviews }): ReactElement => {
  // const GigViewReviews: FC<IGigViewReviewsProps> = ({ showRatings }): ReactElement => {
      ...
      <div className="flex flex-col gap-4">
        {reviews &&
          reviews.map((item: IReviewDocument) => {
            ...
            return (
              <div key={uuidv4()} className="px-2 pb-2">
                <div className="flex flex-col gap-y-3 md:flex-row md:gap-x-4">
                  <img
                    ...
                    src={item.reviewerImage ? item.reviewerImage : 'https://placehold.co/260x220?text=Reviewer%5CnImage'}
                    alt="Reviewer Image"
                  />
                  <div className="flex flex-col self-center">
                    <div className="flex self-center pt-0 no-underline md:block md:self-start md:pt-4">
