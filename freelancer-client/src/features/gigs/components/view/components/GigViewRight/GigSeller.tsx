...
const GigSeller: FC = (): ReactElement => {
  ...
  const chatSeller: IChatSellerProps = {
    ...
    // profilePicture: `${seller.profilePicture !== null ? seller.profilePicture : 'https://placehold.co/220x220?text=Seller+Image'}`,
  ...
  const chatBuyer: IChatBuyerProps = {
    ...
    // profilePicture: `${buyer.profilePicture !== null ? buyer.profilePicture : 'https://placehold.co/220x220?text=Buyer+Image'}`
  };
      ...
      <div className="border-grey mb-8 border rounded">
        ...
        <div className="mb-0 px-4 pt-2">
          <div className="flex flex-col gap-y-3 md:flex-row md:gap-x-2">
            <img
              className="flex h-28 w-24 self-center rounded-full object-cover"
          ...
          <div className="grid grid-cols-1 gap-y-4 lg:grid-cols-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm lg:text-base">Languages</span>
          ...
          <div className="ml-15 mb-2 flex w-full py-1">
            <Button
              ...
              className={`text-md flex w-full justify-between rounded transition duration-500 bg-gradient-to-r from-emerald-600   to-blue-600 px-8 py-2 font-bold text-white focus:outline-none
              ${authUser.username === gig.username ? 'opacity-30 cursor-not-allowed' : 'hover:bg-gradient-to-l cursor-pointer'}
              `}
              label={
                <>
              ...
              onClick={() => {
                if (authUser && !authUser.emailVerified) {
                  setApprovalModalContent({
                    ...
                    btnText: 'OK',
                    btnColor: 'bg-sky-600 hover:bg-sky-400'
                  });
                  setShowModal(true);
                } else {
