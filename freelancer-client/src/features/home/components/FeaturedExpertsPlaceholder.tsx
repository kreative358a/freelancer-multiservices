...
const FeaturedExpertsPlaceholder: FC<IFeaturedExpertProps> = ({ sellers }): ReactElement => {
  return (
          ...
          {sellers.map((seller: ISellerDocument) => (
            ...
            >
              <div className="flex flex-col items-center pb-10 pt-5">
                ...
                <span className="text-sm lg:text-base w-[90%] mb-1 text-gray-500 text-center dark:text-gray-600 dark:text-gray-400">
                  {seller.oneliner}
                </span>
