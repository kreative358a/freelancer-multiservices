      ...
      <div className="relative top-[20%] mx-auto w-11/12 max-w-md rounded bg-slate-200 dark:bg-slate-800  md:w-2/3">
        <div className="relative px-5 py-5">
          <div className="mb-5 flex justify-between text-2xl font-bold text-gray-600">
            <h1 className="flex w-full justify-center  text-blue-950 dark:text-blue-300">Forgot Password</h1>
            <Button
              testId="closeModal"
          ...
          <div className="mb-5 w-full text-center text-base font-normal text-blue-950 dark:text-blue-300">
