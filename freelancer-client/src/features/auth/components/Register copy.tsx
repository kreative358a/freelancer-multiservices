  ...
  const handleFileChange = async (event: ChangeEvent): Promise<void> => {
    ...
    if (target.files) {
      ...
      if (isValid) {
        ...
        setUserInfo({ ...userInfo, profilePicture: `${dataImage}` || 'https://placehold.co/330x220?text=Profile+Image' });
      }
            ...
            <div className="h-24">
              ...
              <div id="country" className="relative mb-5 mt-2 bg-slate-200/80 dark:bg-slate-800/80 ">
                <Dropdown
                  text={country}
                  maxHeight="200"
                  mainClassNames="absolute bg-transparent text-blue-950 text-sm xl:text-base dark:text-blue-200 font-semibold z-50"
