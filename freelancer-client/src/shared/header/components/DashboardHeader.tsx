...
const DashboardHeader: FC = (): ReactElement => {
  ...
  return (
    <>
      ...
      <header>
        <nav className="navbar peer-checked:navbar-active relative z-20 w-full border-b bg-slate-100 dark:bg-slate-900 shadow-2xl shadow-gray-600/5 backdrop-blur dark:shadow-none ">
              ...
              <div className="flex w-full gap-x-4 lg:w-6/12">
                <div className="flex w-full">
                  ...
                  <Link
                    ...
                    className="relative z-10 flex w-full cursor-pointer justify-center self-center pr-12 text-2xl font-bold text-blue-700 dark:text-blue-300 lg:text-3xl"
                  >
                    Seller Dashboard
                  </Link>
                  {/* </div> */}
                        ...
                        label={
                          <>
                            <LazyLoadImage
                              ...
                              // src={
                              //   seller?.profilePicture !== null ? seller?.profilePicture : 'https://placehold.co/330x220?text=Profile+Image'
                              // }
                              alt="profile image"
                            ...
                            {authUsername === authUser.username && (
                              <span className="absolute bottom-1 left-8 md:left-9 xl:left-10 h-2.5 w-2.5 md:h-3.5 md:w-3.5 xl:h-4.5 xl:w4.5 rounded-full border-2 border-white bg-green-400"></span>
                            )}
                          </>
                        }
                      />
