...
const HomeHeader: FC<IHomeHeaderProps> = ({ showCategoryContainer }): ReactElement => {
  ...
  useEffect(() => {
    ...
    // l. 584
    socket.on('order notification', (_, data: IOrderNotification) => {
      // only for receiver
  ...
  return (
    <>
      ...
      <header>
        <nav className="navbar peer-checked:navbar-active relative z-[120] w-full border-b bg-slate-100 dark:bg-slate-900 shadow-2xl shadow-gray-600/5 backdrop-blur dark:shadow-none">
          ...
          <div className="m-auto px-6 xl:container 2xl:w-full md:px-10 lg:px-6 xl:px-4">
            <div className="flex flex-wrap items-center justify-between gap-6 md:gap-0 md:py-3 lg:py-5">
                ...
                <div className="hidden w-full md:flex">
                  ...
                  <div className="w-full gap-x-4 md:flex">
                    <Link
                      ...
                      className="relative z-10 flex cursor-pointer justify-center self-center text-2xl font-semibold dark:font-medium text-slate-700 dark:text-slate-200 lg:text-3xl hover:text-blue-600"
                    >
                      Freelancer
                    </Link>
                    <HeaderSearchInput />
              ...
              <div className="navmenu mb-16 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-gray-100 bg-white p-6 shadow-2xl md:flex-nowrap lg:m-0 lg:flex lg:w-6/12 lg:space-y-0 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none">
                <div className="text-slate-800 dark:text-slate-100">
                  <ul className="flex text-base xl:text-lg font-medium">
                    ...
                    {buyer && !buyer.isSeller && (
                      <li className="relative flex items-center">
                        <Link
                          ...
                          className="cursor-pointer relative ml-auto flex h-9 items-center justify-center rounded-full bg-sky-500 text-white font-bold sm:px-6 hover:bg-sky-400"
                        >
                    ...
                    <li className="relative z-50 flex cursor-pointer items-center">
                      <Button
                        className="relative flex gap-2 px-3 text-base font-medium xl:text-lg"
                        ...
                        label={
                          <>
                            ...
                            {authUsername === authUser.username && (
                              <span className="absolute bottom-0 left-8 md:left-9.5 xl:left-11 h-2.5 w-2.5 md:h-3.5 md:w-3.5 xl:h-4.5 xl:w4.5 rounded-full border-2 border-white bg-green-400"></span>
                            )}
              ...
              <div className="justify-left md:justify-left container mx-auto flex px-6 lg:justify-center">
                ...
                >
                  {categories().map((category: string) => (
                    <span
                      key={uuidv4()}
                      className="mx-4 text-slate-700 dark:text-slate-200 cursor-pointer first:ml-0 hover:text-sky-400 lg:mx-0"
                    >
