            ...
            <div className="flex flex-wrap items-center justify-between gap-6 md:gap-0 md:py-3 lg:py-5">
              <div className="flex w-full items-center justify-between lg:w-auto">
                <Link
                  ...
                  className="relative z-10 cursor-pointer text-xl lg:text-2xl 2xl:text-4xl font-semibold text-white mb-[-24px] xl:mb-[-4px]"
                >
                  Freelancer App
                </Link>
              ...
              <div className="navmenu mb-16 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-gray-100 bg-white p-6 shadow-2xl md:flex-nowrap lg:m-0 lg:flex lg:w-7/12 lg:space-y-0 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none">
                <div className="text-gray-600 dark:text-gray-300 lg:pr-4">
                  <ul className="space-y-6 text-base font-semibold dark:font-medium tracking-wide lg:flex lg:space-y-0 lg:text-sm">
                    <li>
                      <div
                        onClick={() => {
                        ...
                        className="cursor-pointer hover:text-primary text-base font-semibold dark:font-medium lg:text-md 2xl:text-lg dark:hover:text-primaryLight block transition md:px-4"
                      >
                ...
                <div className="border-primary/10 -ml-1 flex w-full flex-col space-y-2 dark:border-gray-700 sm:flex-row md:w-max lg:space-y-0 lg:border-l">
                  <div
                    ...
                    className="cursor-pointer relative ml-auto flex h-9 items-center justify-center before:absolute
                  ...
                  >
                    <span className="relative font-semibold dark:font-medium text-base lg:text-md 2xl:text-lg  text-gray-600 dark:text-gray-300">
                      Sign In
                    </span>
                  </div>
                  <div
                    onClick={() => setShowModal((item: IHeaderModalProps) => ({ ...item, register: true }))}
                    className="cursor-pointer relative ml-auto flex h-9 items-center justify-center rounded-full bg-sky-500
                            text-white font-bold sm:px-6 hover:bg-sky-400"
                  >
                    <span className="relative text-base font-semibold dark:font-medium lg:text-md 2xl:text-lg text-white">Sign Up</span>
                  </div>
                </div>
              </div>
            </div>
