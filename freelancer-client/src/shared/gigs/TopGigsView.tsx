...
const TopGigsView: FC<IGigTopProps> = ({ gigs, title, subTitle, category, width, type }): ReactElement => {
  ...
  return (
    <div className="mx-auto my-4 flex flex-col overflow-hidden rounded-lg ">
      ...
      <div className="m-auto flex h-[580px] w-full overflow-x-auto px-2" ref={navElement}>
        ...
        {!scroll.end && gigs.length > 2 && (
          <span
            onClick={slideRight}
            className="absolute right-2 flex max-w-4xl cursor-pointer justify-end self-center rounded-full bg-sky-400 sm:right-3 md:right-7 lg:right-0 xl:right-4 2xl:right-8"
          >
...
// rounded-md outline outline-blue-600/40 hover:scale-[1.02] duration-300
