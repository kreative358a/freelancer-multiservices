  ...
  return (
    <ModalBg>
      <div className="fixed bottom-0 left-0 right-0 top-0 flex items-center justify-center">
        <div
          // className="relative bottom-auto left-auto right-auto top-auto max-h-[90vh] max-w-[400px] bg-white p-4 text-[#404145]"
          className="rounded bg-slate-200/60 dark:bg-slate-800/60 backdrop-blur relative bottom-auto left-auto right-auto top-auto max-h-[90vh] max-w-[400px] p-4 border-2 border-slate-500/60"
        >
          <div className="border-grey mb-[10px] w-full border-b text-left">
            <h4 className="text-[17px] font-bold mb-1">{header}</h4>
          </div>
