...
import banner_bulb from 'src/assets/banner/banner-bulb.png';
import banner_dollars from 'src/assets/banner/banner-dollars.png';
import banner_robots_arms from 'src/assets/banner/banner-robots-arms.png';

import banner_hr_hand from 'src/assets/banner/banner-hr-hand.png';
// import banner_fish from 'src/assets/banner/banner-fish.png';
// import banner_future from 'src/assets/banner/banner-future.png';
// import banner_hr_arms from 'src/assets/banner/banner-hr-arms.png';
// import banner_book from 'src/assets/banner/banner-book.png';
// import banner_brand from 'src/assets/banner/banner-brand.png';
// import banner_icons from 'src/assets/banner/banner-icons.png';
// import banner_man from 'src/assets/banner/banner-man.png';
// import banner_people from 'src/assets/banner/banner-people.png';

// import banner_robots_man from 'src/assets/banner/banner-robots-man.png';
// import banner_success from 'src/assets/banner/banner-success.png';
// import banner_vision from 'src/assets/banner/banner-vision.png';
// import banner_visual from 'src/assets/banner/banner-visual.png';
// import banner_wheels from 'src/assets/banner/banner-wheels.png';
// import banner_woman from 'src/assets/banner/banner-woman.png';
